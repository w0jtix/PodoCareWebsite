...
export function DropdownSelect<T extends DropdownItem> ({
  ...
  return (
    <div className={`searchable-dropdown relative width-fit-content border-none height-auto ${className}`} ref={dropdownRef}>
      <button
        className={`dropdown-header g-5 flex space-between align-items-center pointer width-fit-content ${disabled ? 'disabled' : ''} ${
